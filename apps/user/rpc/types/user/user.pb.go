...
type DouyinUserRegisterResponse struct {
	...
	Token      string  `protobuf:"bytes,4,opt,name=token,proto3" json:"token,omitempty"`                                // 用户鉴权tok
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x77, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xe9, 0x01, 0x0a, 0x03,
	0x52, 0x70, 0x63, 0x12, 0x4a, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x1f, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f,
	0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e,
	...
	0x53, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x22, 0x2e, 0x75, 0x73,
...
var file_user_proto_depIdxs = []int32{
	...
	2, // 1: user.Rpc.Login:input_type -> user.douyin_user_login_request
	0, // 2: user.Rpc.Register:input_type -> user.douyin_user_register_request
	4, // 3: user.Rpc.UserInfo:input_type -> user.douyin_user_request
	3, // 4: user.Rpc.Login:output_type -> user.douyin_user_login_response
	1, // 5: user.Rpc.Register:output_type -> user.douyin_user_register_response
	5, // 6: user.Rpc.UserInfo:output_type -> user.douyin_user_response
