...
import (
	"awesomeProject/dou-yin/apps/commaction/cmd/rpc/mongodbmanage/internal/config"
	"awesomeProject/dou-yin/apps/commaction/cmd/rpc/mongodbmanage/internal/server"
